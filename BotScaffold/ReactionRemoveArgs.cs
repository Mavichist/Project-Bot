...
{
    /// <summary>
    /// Represents the context surrounding the removal of a reaction from a post.
    /// </summary>
    /// <typeparam name="TConfig">The type of config object for the bot.</typeparam>
    public class ReactionRemoveArgs<TConfig> where TConfig : BotConfig
    {
        /// <summary>
        ...
        /// </summary>
        private MessageReactionRemoveEventArgs Args
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// The emoji that was removed as a reaction.
        /// </summary>
        ...
        public ReactionRemoveArgs(MessageReactionRemoveEventArgs args, TConfig config, bool reactingToMe)
        {
            Args = args;
            Config = config;
