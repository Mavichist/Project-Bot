...
namespace RoleBot
{
    public class RoleManagerBot : BotInstance.Bot<RoleBotConfig>
    {
        ...
        [Command("register emoji", CommandLevel = CommandLevel.Admin, ParameterRegex = "`(?<emojiName>:[\\w\\d-_]+:)`\\s+<@&(?<roleID>\\d+)>")]
        ...
        [Argument("Emoji Name", "This is the name of the emoji. It should include the surrounding colons. Typing an emoji, then wrapping it in ` characters works for this.")]
        [Command("deregister emoji", CommandLevel = CommandLevel.Admin, ParameterRegex = "`(?<emojiName>:[\\w\\d-_]+:)`")]
        ...
        [Command("create reaction post", CommandLevel = CommandLevel.Admin)]
        ...
        [Command("update reaction post", CommandLevel = CommandLevel.Admin)]
        ...
        [Command("create managed role", CommandLevel = CommandLevel.Admin, ParameterRegex = "\"(?<roleName>[\\w\\d_\\-\\s]+)\"\\s+color\\((?<red>\\d+),(?<green>\\d+),(?<blue>\\d+)\\)")]
        ...
        [Command("remove managed role", CommandLevel = CommandLevel.Admin, ParameterRegex = "<@&(?<roleID>\\d+)>")]
        ...
        [Command("manage role", CommandLevel = CommandLevel.Admin, ParameterRegex = "<@&(?<roleID>\\d+)>")]
        ...
        [Command("list unmanaged roles", CommandLevel = CommandLevel.Admin)]
